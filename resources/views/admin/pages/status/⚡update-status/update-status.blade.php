    ...
    <div class="flex flex-col border border-transparent rounded-xl p-4 sm:p-6 lg:p-8 
      ...
      <form wire:submit.prevent="update">
        <div class="grid gap-4 lg:gap-6">
          <!-- Status Name -->
          <div>
            <label for="status_name" class="block mb-2 text-sm font-medium text-white">Status Name</label>
            <input wire:model.defer="status_name" type="text" id="status_name"
            ...
            @error('status_name') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
          </div>
        </div>
