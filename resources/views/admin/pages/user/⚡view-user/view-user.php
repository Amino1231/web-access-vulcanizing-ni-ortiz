...
new #[Layout('layouts.app-admin')] class extends Component
{
    ...
    {
        User::role(['customer', 'shop-owner', 'admin'])->whereIn('id', $this->selectedUsers)->delete();
    ...
    { 
        ...
        { 
            ...
            ->filter(fn($user) => $user->hasRole(['customer', 'shop-owner', 'admin']))
            ->pluck('id')
            ->map(fn($id) => (int) $id)
            ->toArray(); 
        } else { 
    ...
    {
        $allIds = User::role(['customer', 'shop-owner', 'admin'])->pluck('id')->map(fn($id) => (int) $id)->toArray();
    ...
    {
        return User::role(['customer', 'shop-owner', 'admin'])->count();
    }
    ...
    public function users()
    {
        ...
        return User::role(['customer', 'shop-owner', 'admin'])
            ->with('roles:id,name')
