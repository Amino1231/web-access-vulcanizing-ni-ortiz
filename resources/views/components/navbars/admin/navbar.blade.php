        ...
        <div class="lg:pt-15 relative flex flex-col h-full max-h-full">
            ...
            <nav
                ...
                <div class="lg:hidden mb-2 flex items-center justify-between">
                    ...
                    <!-- Sidebar Toggle -->
                    <button type="button"
                        class="p-1.5 size-7.5 inline-flex items-center gap-x-1 text-xs rounded-md text-orange-400isabled:pointer-events-none focus:outline-hidden dark:text-neutral-500"
