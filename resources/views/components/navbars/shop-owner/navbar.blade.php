<div>
    ...
    <div id="hs-pro-sidebar"
        ...
        bg-gray-900 border-gray-700 rounded-lg shadow-lg overflow-hiddenS 
        ...
        <div class="lg:pt-15 relative flex flex-col h-full max-h-full">
            ...
            <nav
                ...
                <div class="lg:hidden mb-2 flex items-center justify-between">
                    ...
                    <!-- Sidebar Toggle -->
                    <button type="button"
                        class="p-1.5 size-7.5 inline-flex items-center gap-x-1 text-xs rounded-md text-orange-400 disabled:pointer-events-none focus:outline-hidden dark:text-neutral-500"
                ...
                <div
                    ...
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-medium text-white rounded-lg hover:bg-orange-400 hover:text-black focus:outline-hidden"
                                wire:current="bg-orange-400"
                                href="{{ route('shop-owner.view-shop') }}">
                                View All My Shop(s)
                            </a>
                        </li>
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-medium text-white rounded-lg hover:bg-orange-400 hover:text-black focus:outline-hidden"
                                wire:current="bg-orange-400"
                                href="{{ route('shop-owner.create-shop') }}">
                                Create New Shop
                            </a>
                        </li>
                    </ul>
